...
const CustomServiceAddComponent: React.FC<Props> = ({ serviceList = [], onChange }) => {
    ...
    const handleAddRow = () => {
        ...
        setRows((prev) => [
            ...prev,
            { id: firstOption.value, name: firstOption.label, value: 1 }, // default qty = 1
        ]);
    };
    ...
    return (
        <View>
            ...
            <Button size="md" variant="solid" action="primary" style={[globalStyles.purpleBackground, { marginHorizontal: wp('2%') }]} onPress={handleAddRow} isDisabled={!availableServices.length}>
