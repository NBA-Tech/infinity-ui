        ...
        fields: [
            ...
            },
            {
                ...
                html: orderDetails?.offeringInfo?.orderType === OrderType.PACKAGE ?
                    `<div class="field"><span>Package:</span>${orderDetails?.offeringInfo?.packageName}</div>` : "",
                isSelected: orderDetails?.quotationHtmlInfo?.some((section) => section?.key === "packageName" && orderDetails?.offeringInfo?.packageName),
            },
            {
                key: "pricingTable",
