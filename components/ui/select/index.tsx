...
const selectInputStyle = tva({
  base: 'py-auto px-3 placeholder:text-typography-500 web:w-full h-full text-typography-900 pointer-events-none web:outline-none ios:leading-[0px] font-inter',
  parentVariants: {
    size: {
      xl: 'text-xl',
      lg: 'text-lg',
